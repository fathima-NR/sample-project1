  ...
  return (
    <div style={{ backgroundColor: "#1a1a1a" }}>
      <div className='hospitality-image'>
        <img className='img-fluid' src="src/assets/Hospitality-scaled.jpg" alt="Hospitality" />
        <div className="hospitality-caption">Office Out Fit</div>
      </div>
